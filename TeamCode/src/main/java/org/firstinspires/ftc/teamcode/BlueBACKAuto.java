...
public class BlueBACKAuto extends OpMode {
    ...
    static double flywheelVelocity = 2350;
    ...
    private final Pose launchPreloadPose = new Pose(56, 15, Math.toRadians(110));
    private final Pose firstTurn = new Pose(32, 10, Math.toRadians(180));
    private final Pose controlPoint1 = new Pose(44, 22);
    private final Pose intakeIn = new Pose(11.5, 9.5, Math.toRadians(180));
    private final Pose intakeOut = new Pose(18, 9.5, Math.toRadians(180));
    private final Pose launchPosition = new Pose(50, 15, Math.toRadians(108));
