...
public class DelayBlueKitBotAuto extends OpMode {

    KitBotRobot robot = new KitBotRobot();

    private Pose startPose = new Pose(21.782, 124.341, Math.toRadians(143));

    private Pose moveToShoot = new Pose(43, 110, Math.toRadians(143));

    private Pose toEnd = new Pose(24, 100, Math.toRadians(180));
    ...
    private void buildPaths() {
        ...
        movingToShoot.setConstantHeadingInterpolation(moveToShoot.getHeading());
