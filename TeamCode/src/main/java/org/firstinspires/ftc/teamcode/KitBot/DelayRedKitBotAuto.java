...
@Autonomous(name = "Delay_Red_KitBotAuto", group = "Auto",  preselectTeleOp= "GoBildaTele")
@Disabled

public class DelayRedKitBotAuto extends OpMode {

    KitBotRobot robot = new KitBotRobot();

    private Pose startPose = new Pose(122, 123, Math.toRadians(37));

    private Pose moveToShoot = new Pose(100, 95, Math.toRadians(50));

    private Pose toEnd = new Pose(122, 100, Math.toRadians(0));
