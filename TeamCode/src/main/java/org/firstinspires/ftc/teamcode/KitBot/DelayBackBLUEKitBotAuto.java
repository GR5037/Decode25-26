...
@Autonomous(name = "DelayBackBLUEKitBotAuto", group = "Auto",  preselectTeleOp= "Blue_KitBotTele")
@Disabled

public class DelayBackBLUEKitBotAuto extends OpMode {

    KitBotRobot robot = new KitBotRobot();

    private Pose startPose = new Pose(60.27704950495049, 5.7192178217821805, Math.toRadians(90));

    private Pose moveToShoot = new Pose(43, 110, Math.toRadians(143));

    private Pose toEnd = new Pose(59, 48, Math.toRadians(150));
    ...
    private void buildPaths() {
        ...
        ending.setLinearHeadingInterpolation(moveToShoot.getHeading(), toEnd.getHeading());
