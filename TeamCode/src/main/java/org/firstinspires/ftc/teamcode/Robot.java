...
public class Robot {
    ...
    static double flyP = 250;
    static double flyI = 0;
    static double flyD = 0;
    static double flyF = 13;
    ...
    static int xBlueGoal = 13;
    static int xRedGoal = 130;
    static int yRedGoal = 128;
    static int yBlueGoal = 128;

    static double xGoal;
    static double yGoal;

    static double velocityA = 0.00477983;
    static double velocityB = 5.90411;
    static double velocityC = 1135.37606;
    static double velocity1;
    static double velocity2;
    static int velocityMax = 2160;
    static int velocityMin = 1250;
    static int flywheelVelocity;
    static double angleA = 0.0000193994;
    static double angleB = -0.00690328;
    static double angleC = 0.864794;
    ...
    static double sP = 0.0005, sI = 0, sD = 0.03, sF = 0.1, spindexAllowedError = 30;
    static double tP = 0.001, tI = 0, tD = 0.05, tF = 0.04, turretAllowedError = 50;
    static double fP = 0.0, fI = 0.0, fD = 0.0, fF = 0.0, flywheelAllowedError = 0;
